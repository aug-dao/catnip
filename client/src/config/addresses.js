export default {
    ...
    kovan: {
        ...
        shareToken: '0xC25c2211a1A9975f3C357322564Bd501ad6f506c'.toLowerCase(),
        markets: [
            '0x9d455D742d582d91aC5ED8AFbbEe2950462151cd'.toLowerCase(),
        ],
        marketInfo: {
            ['0x9d455D742d582d91aC5ED8AFbbEe2950462151cd'.toLowerCase()]: {
                yes: '0x0967675871F33962beab13a52EF03813a9a884CA'.toLowerCase(),
                no: '0x511C37BABe3BF76a674A697326D169de1ED70043'.toLowerCase(),
                Invalid: '0x4053dCBd78b2459c361d2728E28d39BE819bf986'.toLowerCase(),
                outcomeTokens: ['0x0967675871F33962beab13a52EF03813a9a884CA'.toLowerCase(),
                '0x511C37BABe3BF76a674A697326D169de1ED70043'.toLowerCase(),
                '0x4053dCBd78b2459c361d2728E28d39BE819bf986'.toLowerCase()
                ],
                outcomeSymbols: [
                    'yTrump',
                    'nTrump',
            ...
            ['0x4dea3bedae79da692f2675038c4d9b8c246b4fb6'.toLowerCase()]: {
                ...
                outcomeTokens: ['0x1dbCcF29375304c38bd0d162f636BAA8Dd6CcE44'.toLowerCase(),
                '0xeb69840f09A9235df82d9Ed9D43CafFFea2a1eE9'.toLowerCase(),
                '0x0d0Bd297350b49Ee96d5D4E15a12001928fDdB1e'.toLowerCase()
                ],
                outcomeSymbols: [
                    'yTrump',
                    'nTrump',
            ...
            ['0xD3Ba2A2E641F61a5Bcb7a772C49BA6b78E1416e0'.toLowerCase()]: {
                ...
                outcomeTokens: ['0xaC9C1c55901c51b4ff78d957e66bbFE35580528B'.toLowerCase(),
                '0xF7EF92d2a34137dfa2d60A983eb68dbF0ec3db07'.toLowerCase()
                ],
                outcomeSymbols: [
                    'yAnthony',
                    'nAnthony',
    ...
    mainnet: {
        ...
        shareToken: '0x9e4799ff2023819b1272eee430eadf510eDF85f0'.toLowerCase(),
        markets: [
